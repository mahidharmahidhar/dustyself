...
export function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        addToast('Account created successfully! Logging you in...', 'success', 2000);
        setTimeout(() => {
          navigate('/');
        }, 1500);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center py-12 px-4 mt-12">
